...
public class LotTrackingResponse {
    ...
    public void setMainLotMaster(LotMaster lotMaster, int amount) {
        ...
        setEnrollmentType(lotMaster.getEnrollmentType());
        setCreatedDate(lotMaster.getCreatedDate());
        setInputAmount(amount);
    }

    public void setSubLotMaster(List<LotTrackingResponse> dd) {
        setSubLots(dd);
    }
}
