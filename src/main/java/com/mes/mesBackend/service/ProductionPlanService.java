...
public interface ProductionPlanService {
    // 생산계획 수립 전체 조회, 검색조건: 작업공정, 착수예정일
    List<ProductionPlanResponse> getProductionPlans(Long workProcessId, LocalDate fromDate, LocalDate toDate) throws NotFoundException;
    // 생산계획 수립 단일조회
