...
public class ProductInputTestRequestController {
    ...
    public ResponseEntity<List<ItemResponse.noAndName>> getInputTestRequestItems(
        ...
        List<ItemResponse.noAndName> responses = inputTestRequestService.getInputTestRequestItems(PRODUCT);
        cLogger = new MongoLogger(logger, MONGO_TEMPLATE);
    ...
    public ResponseEntity<List<InputTestRequestResponse>> getInputTestRequestLotMasters(
        ...
        List<InputTestRequestResponse> responses = inputTestRequestService.getInputTestRequestLotMasters(itemId, PRODUCT);
        cLogger = new MongoLogger(logger, MONGO_TEMPLATE);
