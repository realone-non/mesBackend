...
public class TestCriteriaController {
    ...
    private final Logger logger = LoggerFactory.getLogger(TestCriteriaController.class);
    ...
    public ResponseEntity<TestCriteriaResponse> createTestCriteria(
        ...
        return new ResponseEntity<>(testCriteria, OK);
    }
    ...
    public ResponseEntity<List<TestCriteriaResponse>> getTestCriterias(
        ...
        return new ResponseEntity<>(testCriterias, OK);
    }
