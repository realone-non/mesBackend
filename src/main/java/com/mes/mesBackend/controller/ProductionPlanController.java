...
public class ProductionPlanController {
    ...
    private final Logger logger = LoggerFactory.getLogger(ProductionPlanController.class);
    ...
    public ResponseEntity<List<ProductionPlanResponse>> getProductionPlans(
            @RequestParam(required = false) @Parameter(description = "작업공정 id") Long workProcessName,
        ...
        List<ProductionPlanResponse> productionPlans = productionPlanService.getProductionPlans(workProcessName, fromDate, toDate);
    ...
    public ResponseEntity<ProductionPlanResponse> getProductionPlan(
        ...
        return new ResponseEntity<>(productionPlan, OK);
    }
