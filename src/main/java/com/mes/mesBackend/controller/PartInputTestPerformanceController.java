...
public class PartInputTestPerformanceController {
    ...
    public ResponseEntity<List<InputTestPerformanceResponse>> getInputTestPerformances(
        ...
        List<InputTestPerformanceResponse> inputTestPerformanceResponses = inputTestPerformanceService.getInputTestPerformances(fromDate, toDate, itemNoAndName, clientId, purchaseInputNo, true);
