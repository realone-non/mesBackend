...
public class GaugeTypeController {
    private final GaugeTypeService gaugeTypeService;
    private final LogService logService;
    private final Logger logger = LoggerFactory.getLogger(GaugeTypeController.class);
    ...
    public ResponseEntity<GaugeTypeResponse> createGaugeType(
        ...
        return new ResponseEntity<>(gaugeType, OK);
    }
    ...
    public ResponseEntity<List<GaugeTypeResponse>> getGaugeTypes(
        ...
        return new ResponseEntity<>(gaugeTypes, OK);
    }
