...
public class UnitController {
    ...
    public ResponseEntity<UnitResponse> getUnit(@PathVariable(value = "id") Long id) throws NotFoundException {
    ...
    public ResponseEntity<Page<UnitResponse>> getUnits(Pageable pageable) {
    ...
    public ResponseEntity<Void> deleteUnit(@PathVariable(value = "id") Long id) throws NotFoundException {
