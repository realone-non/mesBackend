...
public class PartInputTestScheduleController {
    ...
    public ResponseEntity<List<InputTestScheduleResponse>> getPartInputTestSchedules(
        ...
        List<InputTestScheduleResponse> inputTestScheduleResponses = inputTestPerformanceService.getInputTestSchedules(wareHouseId, testType, itemNoAndName, clientId, fromDate, toDate, true);
