...
public class CodeMaster extends BaseTimeEntity {
    ...
    @Column(name = "MAIN_CODE", nullable = false, columnDefinition = "bigint COMMENT '주코드'")
    private String mainCode;    // 주코드

    @Column(name = "CODE_NAME", nullable = false, columnDefinition = "bigint COMMENT '코드명'")
    private String codeName;    // 코드명

    @Column(name = "DEFAULT_NAME", nullable = false, columnDefinition = "bigint COMMENT '기본어명'")
