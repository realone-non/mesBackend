...
public class WorkCenterCheckTypeList extends BaseTimeEntity {
    ...
    @Column(name = "CHECK_CODE", nullable = false, unique = true, columnDefinition = "bigint COMMENT '점검코드'")
    private int checkCode;      // 점검코드

    @Column(name = "CHECK_CATEGORY", nullable = false, columnDefinition = "bigint COMMENT '점검항목'")
    private String checkCategory;   // 점검항목

    @Column(name = "CHECK_CONTENT", nullable = false, columnDefinition = "bigint COMMENT '점검내용'")
    private String checkContent;    // 점검내용

    @Column(name = "CHECK_CRITERIA", nullable = false, columnDefinition = "bigint COMMENT '판정기준'")
    private String checkCriteria;        // 판정기준

    @Column(name = "CHECK_METHOD", nullable = false, columnDefinition = "bigint COMMENT '판정방법'")
    private String checkMethod;        // 판정방법

    @Column(name = "INPUT_TYPE", nullable = false, columnDefinition = "bigint COMMENT '입력방법'")
    private String inputType;       // 입력방법

    @Column(name = "INPUT_NUMBER_FORMAT", columnDefinition = "bigint COMMENT '숫자입력포맷'")
    ...
    @Column(name = "ORDERS", nullable = false, columnDefinition = "bigint COMMENT '표시순서'")
