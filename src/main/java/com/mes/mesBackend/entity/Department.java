...
public class Department extends BaseTimeEntity{
    ...
    @Column(name = "DEPT_CODE", nullable = false, columnDefinition = "bigint COMMENT '부서코드'")
    private int deptCode; // 부서코드

    @Column(name = "DEPT_NAME", nullable = false, columnDefinition = "bigint COMMENT '부서명'")
    private String deptName;    // 부서명

    @Column(name = "SHORT_NAME", nullable = false, columnDefinition = "bigint COMMENT '부서약어명'")
